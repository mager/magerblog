...
import magerblogDesign from '../../data/design-md/magerblog.md?raw';
import kotsuDesign from '../../data/design-md/kotsu.md?raw';
import loooomDesign from '../../data/design-md/loooom.md?raw';
import prxpsDesign from '../../data/design-md/prxps.md?raw';
import beatbrainDesign from '../../data/design-md/beatbrain-v2.md?raw';
import impeccableDesign from '../../data/design-md/impeccable.md?raw';
...
These are long enough that they are better treated as artifacts than excerpts. The code panels below are Markdown blocks, so they collapse, expand, copy, and fullscreen like the rest of the code on this site.

### magerblog `DESIGN.md`

<MarkdownCodeBlock code={magerblogDesign} label="magerblog DESIGN.md" />

### Kotsu `DESIGN.md`

<MarkdownCodeBlock code={kotsuDesign} label="Kotsu DESIGN.md" />

### Loooom `DESIGN.md`

<MarkdownCodeBlock code={loooomDesign} label="Loooom DESIGN.md" />

### prxps `DESIGN.md`

<MarkdownCodeBlock code={prxpsDesign} label="prxps DESIGN.md" />

### Beatbrain `DESIGN.md`

<MarkdownCodeBlock code={beatbrainDesign} label="Beatbrain DESIGN.md" />

### Impeccable `DESIGN.md`

<MarkdownCodeBlock code={impeccableDesign} label="Impeccable DESIGN.md" />

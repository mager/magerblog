...
This is a personal blog built with Astro v5, featuring three main content categories: Code, Life, and Recipes. The site uses a dark, terminal-inspired design theme reminiscent of code editors like Claude Code, with category-specific color schemes applied to images and navigation elements.
